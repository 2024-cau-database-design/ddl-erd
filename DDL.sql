...
CREATE TABLE IF NOT EXISTS `restaurant`.`restaurant` (
  ...
  `owner_id` INT NULL,
  `owner_id1` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_restaurant_owner1_idx` (`owner_id1` ASC) VISIBLE,
  CONSTRAINT `fk_restaurant_owner1`
    FOREIGN KEY (`owner_id1`)
...
CREATE TABLE IF NOT EXISTS `Restaurant_Reservation`.`waiting_history` (
  ...
  PRIMARY KEY (`id`, `waiting_status_id`),
