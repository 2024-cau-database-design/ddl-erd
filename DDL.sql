...
CREATE TABLE IF NOT EXISTS `Restaurant_Reservation`.`restaurant_table` (
  ...
  `is_deleted` TINYINT(1) NOT NULL,
  `deleted_at` DATETIME NULL,
  `restaurant_tablecol` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `Restaurant_Reservation`.`payment` (
  ...
  `is_deleted` TINYINT(1) NOT NULL,
  `deleted_at` DATETIME NULL,
  `method` VARCHAR(20) NULL COMMENT 'CARD, COUPON\n',
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `Restaurant_Reservation`.`custom_schedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Restaurant_Reservation`.`custom_schedule` (
  `id` INT NULL,
  `date` DATE NULL,
...
-- -----------------------------------------------------
-- Table `Restaurant_Reservation`.`user_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Restaurant_Reservation`.`user_role` (
  `id` INT NOT NULL,
  `role_id` INT NOT NULL,
  PRIMARY KEY (`id`, `role_id`),
  INDEX `fk_user_role_role1_idx` (`role_id` ASC) VISIBLE,
  CONSTRAINT `fk_role_user_auth10`
    FOREIGN KEY (`id`)
    REFERENCES `Restaurant_Reservation`.`user_auth` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_role_role1`
    FOREIGN KEY (`role_id`)
    REFERENCES `Restaurant_Reservation`.`role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
